...
public class AutoID extends SequentialCommandGroup {
    ...
    public AutoID(DriveSubsystem drive, Intake intake, Shooter shooter, int ID, int iter, String alliance) {
    ...
    public SequentialCommandGroup get3(int pos) {
        ...
        return new SequentialCommandGroup(setStarting(pos), shootPre, getTheRing, driveForward, shootFinal, getOut);
    }
